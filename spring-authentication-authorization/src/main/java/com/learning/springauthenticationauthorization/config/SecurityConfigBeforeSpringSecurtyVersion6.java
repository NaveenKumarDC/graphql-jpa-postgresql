...
// In 6.0, @Configuration is removed from @EnableWebSecurity, @EnableMethodSecurity, @EnableGlobalMethodSecurity, and @EnableGlobalAuthentication.
public class SecurityConfigBeforeSpringSecurtyVersion6 {
  ...
  // Configuring HttpSecurity before Spring security 6.1...Deprecated
  //@Bean
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    // After 6.1 the below code is deprecated
